...
exports.parseScrapeRequest = function (req) {
    var qs = req.url.split('?');
    var params = common.querystringParse(qs[1]);
...
exports.parseAnnounceRequest = function (req) {
    var qs = req.url.split('?');
    var params = common.querystringParse(qs[1]);
...
// TODO: parseHttpRequest is deprecated
