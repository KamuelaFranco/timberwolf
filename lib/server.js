// TODO: Make use of this library and associated libraries - tip: extend this rather than implement in other places
...
var parseHttpRequest = require('./parse_http');
var parseUdpRequest = require('./parse_udp');
...
Server.prototype.getSwarm = function (infoHash) {
  ...
  if (self._filter && !self._filter(infoHash))
    return null;
  var swarm = self.torrents[infoHash];
  if (!swarm)
    swarm = self.torrents[infoHash] = new Swarm(infoHash, this);
  return swarm;
};
